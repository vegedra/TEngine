...
incluam este cabeçalho. Isso permite que outros arquivos saibam que essas funções existem e como 
chamá-las, mesmo que não tenham acesso à sua implementação real. */